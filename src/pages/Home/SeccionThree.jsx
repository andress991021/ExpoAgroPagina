  ...
  return (
    <div>
      <div className="  w-full relative ">
        <img
          className="w-full lg:w-full h-64 lg:h-full"
          src={Banner01}
          alt=""
        />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-1 static z-40 ">
        ...
        <div className="lg:mx-20 mx-5 lg:w-1/2 ">
          ...
          <p className="text-base lg:text-xl    lg:w-full text-justify">
            ...
            agroforestal, destacada por nuestra calidad y compromiso, es nuestro
            objetivo principal.
          </p>
          ...
          <p className="text-base lg:text-xl    lg:w-full text-justify">
            ...
            su competitividad. Nuestro compromiso con el crecimiento del sector
            productivo del campo y la conservación del medio ambiente es
      ...
      <div className="  w-full relative mt-32 lg:mt-0 ">
        <img
          className="mx-auto w-1/2 absolute -top-28 inset-x-0 lg:hidden  "
          src={Campesino}
          alt=""
        />
        <img
          className="w-full lg:w-full hidden lg:block "
          src={Cenefa01}
          alt=""
        />
        <img
          className="w-full lg:w-full lg:hidden  "
          src={CenefaMobile}
          alt=""
        />
        <img
          className="w-10 lg:w-1/3 lg:absolute -top-60 right-20 hidden lg:block  "
          src={Campesino}
          alt=""
        />
