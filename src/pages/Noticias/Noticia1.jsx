    ...
    <div className="pt-16 md:pt-0  lg:mt-24  ">
      <div className=" mb-12 lg:mb-24 md:pt-16 lg:pt-0">
        <PublicacionBlog
          ...
          text={
            "Mantenemos estrechos lazos con el mercado de semillas en latinoamerica, en momentos que en los distintos países firman acuerdos de libre comercio y el sector agricola se expande y se une para ser competitivo en el mercando internacional."
          }
          moreinfo={false}
        />
        ...
        <div className="mx-auto  lg:w-3/4">
          ...
          <div className="m-10">
            ...
            <div className="mt-5">
              <p className="text-base lg:text-lg font-bold  lg:w-full text-justify">
                COSTA RICA
              </p>
              <p className="text-base lg:text-lg  lg:w-full text-justify">
                Distribuidores autorizados para Colombia en semilla de Teca
                Escarificada Mejorada y Melina de Huerto Semillero de Semillas y
                Bosques.
              </p>
            </div>
          </div>
